...
plot(dtime, data3$Voltage, pch = 46, xlab = "", ylab = "Voltage")

lines(dtime, data3$Voltage)
...
plot(dtime, data3$Global_reactive_power, pch = 46, xlab = "", ylab = "Global reactice power")

lines(dtime, data3$Global_reactive_power)
